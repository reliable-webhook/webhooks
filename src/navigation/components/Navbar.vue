    ...
    <div class="px-2 sm:px-6">
      <div class="relative flex items-center justify-between h-10">
        ...
        <div
          ...
          class="flex flex-1 justify-center items-center space-x-4 w-1/3"
        >
          <UIAlert
        ...
        <div
          v-else
          class="hidden md:flex justify-center w-1/3"
        >
          <a
            href="#"
            @click.prevent="openCharityModal"
          >
            🇺🇦 Learn about charityware
          </a>
        </div>
